...
Qyno Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 37110.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 37111 for connections and services them.
...
However, in open source software such as Qyno Core, where everyone uses
...
pay attention to for reviewers of Qyno Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Qyno Core uses tinyformat, which is type safe. Leave them out to avoid confusion
