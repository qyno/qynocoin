...
In order to support loading of multiple wallets in qyno-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is qyno.cpp.
...
Changes to qyno.cpp
----------------------
qyno.cpp is the entry point into qyno-qt, and as such, will require some minor modifications to provide hooks for
