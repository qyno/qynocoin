...
This mechanism has been integrated into Bitcore-Node-Qyno which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Qyno-Project/insight-api-qyno#web-socket-api](https://github.com/Qyno-Project/insight-api-qyno#web-socket-api) 
* API: [https://github.com/Qyno-Project/insight-api-qyno#instantsend-transactions](https://github.com/Qyno-Project/insight-api-qyno#instantsend-transactions) 
...
By default, the Qyno Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Qyno Core daemon:
