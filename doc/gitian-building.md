...
*Setup instructions for a gitian build of Qyno using a Debian VM or physical system.*
...
Clone the git repositories for qyno and gitian and then checkout the qyno version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/qyno-crypto/qyno.git
cd qyno
...
Follow the instructions in [doc/release-process.md](release-process.md) in the qyno repository
...
To build Qyno (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the qyno repository.
...
```bash
    ...
    From https://github.com/qyno-crypto/qyno
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/qyno-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/qyno-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/qyno-build.assert
```
...
[qyno/gitian.sigs](https://github.com/qyno-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
