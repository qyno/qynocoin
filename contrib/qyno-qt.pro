...
RESOURCES += src/qt/qyno.qrc src/qt/qyno_locale.qrc

TRANSLATIONS += src/qt/locale/qyno_bg.ts \
                src/qt/locale/qyno_de.ts \
                src/qt/locale/qyno_en.ts \
                src/qt/locale/qyno_es.ts \
                src/qt/locale/qyno_fi.ts \
                src/qt/locale/qyno_fr.ts \
                src/qt/locale/qyno_it.ts \
                src/qt/locale/qyno_ja.ts \
                src/qt/locale/qyno_pl.ts \
                src/qt/locale/qyno_pt.ts \
                src/qt/locale/qyno_ru.ts \
                src/qt/locale/qyno_sk.ts \
                src/qt/locale/qyno_sv.ts \
                src/qt/locale/qyno_vi.ts \
                src/qt/locale/qyno_zh_CN.ts \
                src/qt/locale/qyno_zh_TW.ts
