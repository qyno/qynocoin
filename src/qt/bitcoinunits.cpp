...
QString BitcoinUnits::id(int unit)
{
    ...
    case QNO:
        return QString("qyno");
    case mQNO:
        return QString("mqyno");
    case uQNO:
        return QString::fromUtf8("uqyno");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case QNO:
            return QString("tQNO");
        case mQNO:
            return QString("mtQNO");
        case uQNO:
            return QString::fromUtf8("μtQNO");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case QNO:
            return QString("QNO");
        case mQNO:
            return QString("Milli-QNO (1 / 1" THIN_SP_UTF8 "000)");
        case uQNO:
            return QString("Micro-QNO (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case QNO:
            return QString("TestQNOs");
        case mQNO:
            return QString("Milli-TestQNO (1 / 1" THIN_SP_UTF8 "000)");
        case uQNO:
            return QString("Micro-TestQNO (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
