...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Qyno Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Qyno"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Qyno Core help message to get a list with possible Qyno command-line options"));
