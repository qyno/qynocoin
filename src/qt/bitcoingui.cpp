    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Qyno Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Qyno address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and qyno: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Qyno Core"), this);
    aboutAction->setStatusTip(tr("Show information about Qyno Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Qyno Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Qyno addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Qyno addresses"));
    ...
    openAction->setStatusTip(tr("Open a qyno: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Qyno Core help message to get a list with possible Qyno Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Qyno Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Qyno network", "", count));
    } else {
...
{
    QString strTitle = tr("Qyno Core"); // default title
