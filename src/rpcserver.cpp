...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Qyno features */
        {"qyno", "masternode", &masternode, true, true, false},
        {"qyno", "listmasternodes", &listmasternodes, true, true, false},
        {"qyno", "getmasternodecount", &getmasternodecount, true, true, false},
        {"qyno", "masternodeconnect", &masternodeconnect, true, true, false},
        {"qyno", "masternodecurrent", &masternodecurrent, true, true, false},
        {"qyno", "masternodedebug", &masternodedebug, true, true, false},
        {"qyno", "startmasternode", &startmasternode, true, true, false},
        {"qyno", "createmasternodekey", &createmasternodekey, true, true, false},
        {"qyno", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"qyno", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"qyno", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"qyno", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"qyno", "getmasternodescores", &getmasternodescores, true, true, false},
        {"qyno", "mnbudget", &mnbudget, true, true, false},
        {"qyno", "preparebudget", &preparebudget, true, true, false},
        {"qyno", "submitbudget", &submitbudget, true, true, false},
        {"qyno", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"qyno", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"qyno", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"qyno", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"qyno", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"qyno", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"qyno", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"qyno", "checkbudgets", &checkbudgets, true, true, false},
        {"qyno", "mnsync", &mnsync, true, true, false},
        {"qyno", "spork", &spork, true, true, false},
        {"qyno", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"qyno", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use qynod, or the -server option to qyno-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> qyno-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:39742/\n";
}
