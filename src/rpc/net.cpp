...
UniValue getpeerinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"subver\": \"/Qyno Core:x.x.x/\",  (string) The string version\n"
...
UniValue addnode(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2 ||
        ...
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("addnode", "\"192.168.0.6:37110\" \"onetry\"")
            + HelpExampleRpc("addnode", "\"192.168.0.6:37110\", \"onetry\"")
        );
...
UniValue disconnectnode(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "1. \"node\"     (string, required) The node (see getpeerinfo for nodes)\n"
            "\nExamples:\n"
            + HelpExampleCli("disconnectnode", "\"192.168.0.6:37110\"")
            + HelpExampleRpc("disconnectnode", "\"192.168.0.6:37110\"")
        );
...
UniValue getaddednodeinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "       {\n"
            "         \"address\" : \"192.168.0.201:37110\",  (string) The qyno server IP and port we're connected to\n"
...
UniValue getnetworkinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"subversion\": \"/Qyno Core:x.x.x/\",     (string) the server subversion string\n"
