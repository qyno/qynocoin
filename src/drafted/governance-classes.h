 ...
 *
 *   // network
 *   CQynoNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.qyno.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CQynoNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: QynoNetwork
// //   -- signature requirements : Key1(User)
// class CQynoNetworkVariable : public CGovernanceObject
// {
// private:
