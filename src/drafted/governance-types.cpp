...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "QynoNetwork") type = QynoNetwork;
    if(strType == "QynoNetworkVariable") type = QynoNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == QynoNetwork) s = "QynoNetwork";
    if(type == QynoNetworkVariable) s = "QynoNetworkVariable";
