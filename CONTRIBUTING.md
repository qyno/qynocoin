Contributing to Qyno Core
============================

The Qyno Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Qyno Core project, and is not to be
confused with overall Qyno Network Protocol consensus changes.

Whether a pull request is merged into Qyno Core rests with the project merge
...
Patches that change Qyno consensus rules are considerably more involved than
...
Where a patch set proposes to change the Qyno consensus, it must have been
...
The project leader is the release manager for each Qyno Core release.
